...
import { updateHubProjectSubscription, HubProjectSubscription } from "@/services/hubprojectsubscriptions";
...
interface UpdateHubProjectSubscriptionProps {
  subscription: HubProjectSubscription;
  onSuccess: () => void;
  onCancel: () => void;
}

export default function UpdateHubProjectSubscriptionForm({ subscription, onSuccess, onCancel }: UpdateHubProjectSubscriptionProps) {
  ...
  const mutation = useMutation({
    mutationFn: (data: any) => updateHubProjectSubscription(subscription.reference, data, header),
    onSuccess: () => {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      custom_price: parseFloat(subscription.custom_price || "0"),
    },
