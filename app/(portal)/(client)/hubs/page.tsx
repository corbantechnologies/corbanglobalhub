...
export default function ClientHubsPage() {
  ...
  return (
    <div className="p-6 md:p-10 space-y-6 mx-auto">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Your Hubs</h1>
          <p className="text-slate-500 mt-1">View and manage your infrastructure hubs</p>
        </div>
      </div>
        ...
        <div className="flex-1 overflow-auto">
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center h-full min-h-[400px] text-slate-500">
              ...
              <p className="text-sm">You don't have any hubs configured yet.</p>
            </div>
          ) : (
